  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <ul className='md:flex items-start gap-5 font-medium hidden'>
        <NavLink to='/' className={({isActive})=>isActive?'text-blue-400 font-bold':'text-gray-700'} >
          <li className='py-1'>HOME</li>
        </NavLink>
        <NavLink to='/doctors'className={({isActive})=>isActive?'text-blue-400 font-bold':'text-gray-700'} >
          <li className='py-1'>ALL DOCTORS</li>
        </NavLink>
        <NavLink to='/about' className={({isActive})=>isActive?'text-blue-400 font-bold':'text-gray-700'}>
      ...
      <div className='flex items-center gap-4 '>
        ...
        <div className={`md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all ${showMenu ? 'fixed w-full' : 'h-0 w-0'}`}>
          ...
          <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
            <NavLink onClick={() => setShowMenu(false)} to='/' className={({isActive})=>isActive?'text-blue-400 font-bold':'text-gray-700'}><p className='px-4 py-2 rounded full inline-block'>HOME</p></NavLink>
